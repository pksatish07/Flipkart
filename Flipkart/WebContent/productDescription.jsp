...
<script>
	$(document).ready(function() {
						$("button").click(function() {
							...
							if(id == "buyNow")
							{
							   document.location ="/Flipkart/PlaceOrderLoginCart.action";
							}
							<%}
								...
								$.post(
										'/Flipkart/cartAdditionOnSession.action',
										{
			...
			<div class="panel-body" style="background: white;">
				...
				<div class="col-md-4">
					...
					<div class="row">
						...
						<h3 style="color: silver; font-family: cursive;">
							(
					...
					<%}%>
						...
						<BR>
						<div class="row">
							<button type="button" class="btn btn-success" id="buyNow"
					...
					<s:else>
						<div class="row">
							...
							<h5>This item is out of stock!</h5>
							<div class="notify-me-form-wrap">
								<div class="notify-me-title"><b>Notify me when this product
									is in Stock:</b></div>
								<form name="notify-me-form" onsubmit="">
									<span class="email-text">Email</span>: <input type="hidden"
										name="fsn" value=""> <input
										type="hidden" name="referrer"
										value="">
									<input type="hidden" name="price" value=""> <input
										type="text" class="email-id" name="email-id" 
										maxlength="50" value=""
										placeholder="Enter your Email id"> 
									<button style="margin-top:0.2cm "type="button" class="btn btn-default">NOTIFY ME</button>
								</form>
							</div>
						</div>
