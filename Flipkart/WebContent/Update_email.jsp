 ...
 <body  style = "background:#F5F5F5;" >
    ...
    <br>       
		...
		<div class="col-md-8 col-md-offset-2">
				<h3 ><strong>Update Email</strong></h3>
				<br>
				<strong>Enter the new Email ID that you wish to associate with your Flipkart account. </strong>
				<br><br>
				<form action="updateemail" class="form-horizontal" method="post" enctype="multipart/form-data">
							
								<p>	<label for="name">Email Address</label>
							    <s:property  value="email"/></p>	
					<br>					
							<p>		<label >New Email ID</label> <input type="text"
									 name="newemailid" id="newemailid"></p>	
							<br>				
				...
				<strong>What happens when the Email ID is updated?</strong><br><br>
				<ul>
				
<li>Wallet balance is transferred to the new account</li>
<li>Your order history is available under the new account</li>
<li>Your wishlist items are associated with the new account's URL. The list's previous hyperlink is cleared</li>
<li>Profile activity (including your reviews and ratings) is migrated likewise</li>
</ul>
...
function performAction(form)
{
	...
	xmlhttp.open("POST","updateemail",true);
