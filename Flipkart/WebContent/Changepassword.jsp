 ...
 <body  style = "background:#F5F5F5;" >
    ...
    <br>       
		...
		<div class="col-md-8 col-md-offset-2">
				...
				<br>
				<form action="changepassword" class="form-horizontal" method="post" enctype="multipart/form-data">
					...
					<br>
							<p>	<label >Old Password</label>
								<input type="password"
									 name="oldpassword" id="oldpassword"><p>
						<br>
					
							<p>	<label >New Password</label>
								 <input type="password"
									 name="newpassword" id="newpassword"><p>
							<br>
				
							<p>	<label >Retype New Password</label>
								 <input type="password"
									 name="retype" id="retype"><p>
